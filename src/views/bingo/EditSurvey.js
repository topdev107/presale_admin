...
const EditSurvey = () => {
    ...
    const OnUpdateSurvey = () => {
        ...
        let s_id = params[params.length - 1];
        updateSurvey(s_id, type, question, answers);
    }
    ...
    const getSurvey = (s_id) => {
        axios.get(window.BASE_URL + '/surveys/' + s_id)
            .then((response) => {
                if (response.data.status == "success") {
                    ...
                    if (data.type == "text") {
                        ...
                        setAnswerRowsOpt(data.answers);
                        setAnswerRowsCheckbox([]);
                    } else if (data.type == "checkbox") {
                        setAnswerRowsOpt([]);
                        setAnswerRowsCheckbox(data.answers);
                    }
    ...
    const updateSurvey = (s_id, type, question, answers) => {
        axios.put(window.BASE_URL + '/surveys/' + s_id, {
            "type": type,
            "question": question,
            "answers": answers
        })
                ...
                <CCard className="mb-4">
                    <CCardBody className="t_height_80vh mt-5">
                        ...
                        <div className="d-grid gap-3 d-md-flex justify-content-md-end mb-5 mt-3">
                            ...
                            <CButton color="success" className="me-md-2 width-200" onClick={OnUpdateSurvey}>
                                Update
                            </CButton>
                        </div>
                    </CCardBody>

        ...
        Swal.fire({
            ...
            .then((result) => {
                ...
                if (result['isConfirmed']) {
                    axios.put("https://presale-backend.vercel.app/presale/launchpad/" + id + "?chainId=25", 'verified=true')
                        .then((res) => {
                            console.log('res: ', res);
                            if (res.status == 200) {
                                Swal.fire({
    ...
    const handleDelete = useCallback(async (id) => {
        Swal.fire({
            ...
            .then((result) => {
                console.log('result: ', result);
                if (result['isConfirmed']) {
                    axios.delete("https://presale-backend.vercel.app/presale/launchpad/" + id + "?chainId=25")
                        .then((res) => {
                            console.log('res: ', res);
                            if (res.status == 200) {
                                Swal.fire({
